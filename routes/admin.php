...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/products/disable_product', 'ProductController@adminDisableProductStatus')->name('products.disable_product');
    ...
    // customer shop approve
    Route::post('/customer/approved', 'CustomerController@updateApproved')->name('customer.approved');
    Route::get('/customer/view/{id}/verification', 'CustomerController@show_verification_request')->name('customer.show_verification_request');
    Route::get('/customer/approve/{id}', 'CustomerController@approve_customer')->name('customer.approve');
    Route::get('/customer/reject/{id}', 'CustomerController@reject_customer')->name('customer.reject');

    //unblockUsers requset
    Route::resource('unblock', 'BlockUserController');
    Route::get('/block/users', 'BlockUserController@blockUserList')->name('unblock.blockUserList');
    Route::get('/unblock/destroy/{id}', 'BlockUserController@destroy')->name('unblock.destroy');


    // customer verification form
    // Route::get('/verification/form', 'BusinessSettingsController@customer_verification_form')->name('customer_verification_form.index');
    // Route::post('/verification/form', 'BusinessSettingsController@customer_verification_form_update')->name('customer_verification_form.update');
});
