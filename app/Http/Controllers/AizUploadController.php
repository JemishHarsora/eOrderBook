...
class AizUploadController extends Controller
{
    ...
    public function index(Request $request){
        ...
        {
            return view('frontend.uploaded_files.index', compact('all_uploads', 'search', 'sort_by') );
        }
    }
    ...
    public function create(){
        ...
        {
            return view('frontend.uploaded_files.create');
        }
    }
    ...
    public function get_uploaded_files(Request $request)
    {
        ...
        return $uploads->paginate(30)->appends(request()->query());
    }
