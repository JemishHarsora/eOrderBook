...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($products) {
            ...
            $sellerP = ProductPrice::where('seller_id', $seller_id)->where('product_id', $products->id)->first();
            if ($sellerP) {
                flash(translate('This product already exist'))->error();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($product->meta_title == null) {
            $product->meta_title = ucfirst($product->name);
        }
