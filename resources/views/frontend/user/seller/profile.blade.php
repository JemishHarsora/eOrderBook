                ...
                <form action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">{{ translate('Business Type')}}</label>

                                <div class="col-md-10">
                                    <select class="form-control aiz-selectpicker" name="business_category[]" id="business_category" data-selected="{{ Auth::user()->business_category }}" data-live-search="true" multiple required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" placeholder="{{ translate('Your Address')}}"
                                        rows="2" name="address" required>{{ Auth::user()->address }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control aiz-selectpicker" data-live-search="true" data-selected="{{ Auth::user()->city }}" name="city"
                                    required id="city_id">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">{{ translate('Area') }}</label>
                                <div class="col-md-10">
                                    <select class="form-control mb-3 aiz-selectpicker" id="area_id" data-live-search="true" data-selected="{{ Auth::user()->area }}" name="area"
                                        required>
                                        @foreach (\App\Area::get() as $key => $area)
                                    ...
                                    <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                        ...
                                        <div class="dropdown position-absolute right-0 top-0">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                @endif
                                                <a class="dropdown-item"
                                                    href="#" onclick="add_new_address()">{{ translate('Edit') }}</a>
                                                <a class="dropdown-item"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-3">
                                    <input value="1" name="bank_payment_status" type="checkbox" @if
                                        (Auth::user()->seller->bank_payment_status == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your City')}}"
...
<script type="text/javascript">
    $('#business_category').selectpicker('val', [{{Auth::user()->business_category}}]);
