                ...
                <div class="aiz-user-panel">
                    ...
                    <form class="" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control text-capitalize" name="name" placeholder="{{ translate('Product Name') }}" onchange="update_sku()" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="sku" placeholder="{{ translate('SKU Name') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Manufacturer') }}</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="mfd_by" placeholder="{{ translate('Manufacturer') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Marketed By') }}</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="marketed_by" placeholder="{{ translate('Marketed By') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="hsn_code" placeholder="{{ translate('HSN Code') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" lang="en" class="form-control" name="barcode" placeholder="{{ translate('Barcode') }}" required minlength="13" maxlength="13">
                                    </div>
                                </div>
                                {{-- @endif --}}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('MRP') }}</label>
                                    <div class="col-md-6">
                                        <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('MRP') }}" name="unit_price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Selling Price') }}</label>
                                    <div class="col-md-6">
                                        <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Selling Price') }}" name="purchase_price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row" id="quantity">
                                    <label class="col-md-3 col-from-label">{{ translate('Stock') }}</label>
                                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="aiz-text-editor text-capitalize" name="description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Description') }}</label>
                                    <div class="col-md-8">
                                        <textarea name="meta_description" rows="8" class="form-control text-capitalize"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
