                                ...
                                <a href="{{ route('seller_packages_list') }}"
                                    ...
                                    @if ($seller_package != null)
                                        <img src="{{ uploaded_asset($seller_package->logo) }}"
                                            ...
                                            height="44" class="mw-100 mx-auto">
                                ...
                                <tbody>
                                    ...
                                    @if($prices->product)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($prices->product->category != null)
                                                    {{ $prices->product->category->getTranslation('name') }}
                                                @endif
                                            </td>
                                            <td>
                                                @php
                                                    $qty = 0;
                                                    if ($prices->product->variant_product) {
                                                        foreach ($prices->product->stocks as $key => $stock) {
                                                            $qty += $stock->qty;
                                                        }
                                                    } else {
                                                        $qty = $prices->current_stock;
                                                    }
                                                    echo $qty;
                                                @endphp
                                            </td>
                                            ...
                                            <td>
                                                <label class="aiz-switch aiz-switch-success mb-0">
                                                    <input onchange="update_published(this)"
                                                        value="{{ $prices->product->id }}" type="checkbox" <?php if ($prices->published == 1) {
                                                    echo 'checked';
                                                    } ?> >
                                            ...
                                            <td>
                                                <label class="aiz-switch aiz-switch-success mb-0">
                                                    <input onchange="update_featured(this)"
                                                        value="{{ $prices->product->id }}" type="checkbox" <?php if ($prices->seller_featured == 1) {
                                                    echo 'checked';
                                                    } ?> >
                                                    <span class="slider round"></span>
                                                </label>
                                            ...
                                            <td class="text-right">
                                                ...
                                                {{-- <a href="{{route('products.duplicate', $prices->product->id)}}" class="btn btn-soft-success btn-icon btn-circle btn-sm"  title="{{ translate('Duplicate') }}">
