                ...
                <div class="aiz-titlebar mt-2 mb-4">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                              ...
                              <div class="card">
                                  ...
                                  <div class="card-body text-center">
                                      @if($seller_package != null)
                                        <img src="{{ uploaded_asset($seller_package->logo) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" class="img-fluid mb-4 h-110px">
                          ...
                          <div class="bg-white mt-4 p-4 text-center" style="overflow: auto;word-break: break-all;">
