                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="aiz-titlebar mt-2 mb-4">
                      <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="h3">{{ translate('Product Stock Update') }}</h1>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table aiz-table mb-0" style="font-size:14px; background-color: #cce5ff; border-color: #b8daff">
                                ...
                                <a href="{{ static_asset('download/product_stock_update_sku_demo.xlsx') }}" download><button class="btn btn-primary mt-2">{{ translate('Download SKU Demo CSV')}}</button></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('product_stock_update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
