        ...
        <div class="row cols-xs-space cols-sm-space cols-md-space">
            ...
            <div class="col-lg-9">
                <div class="main-content">
                            ...
                            <div class="col-md-6">
                                <div class="float-md-right">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active"><a
                                                href="{{ route('customerShops.index') }}">{{ translate('Shop Settings')}}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <form class="" action="{{ route('customer.shop.verify.store') }}" method="POST"
                        ...
                        <div class="form-box bg-white mt-4">
                            ...
                            @php
                            $verification_form = \App\BusinessSetting::where('type',
                            'verification_form')->first()->value;
                            @endphp
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="{{ $element->type }}" name="element_{{ $key }}"
                                            id="file-{{ $key }}" class="custom-input-file custom-input-file--4"
