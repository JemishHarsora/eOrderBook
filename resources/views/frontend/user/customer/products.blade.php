                        ...
                        <div class="col-md-4">
                            <a href="{{ route('customer_packages_list_show') }}" class="text-center bg-white shadow-sm hov-shadow-lg text-center d-block p-3 rounded">
                                @if($customer_package != null)
                                    <img src="{{ uploaded_asset($customer_package->logo) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" height="44" class="mw-100 mx-auto">
