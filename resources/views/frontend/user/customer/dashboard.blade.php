                ...
                <div class="row gutters-10">
                    <div class="col-md-4">
                        <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                @if(Session::has('cart'))
                                <div class="h3 fw-700">{{ count(Session::get('cart'))}} {{ translate('Product(s)') }}
                                </div>
                                @else
                    ...
                    <div class="col-md-4">
                        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                ...
                                @endphp
                                <div class="h3 fw-700">{{ count(Auth::user()->wishlists)}} {{ translate('Product(s)') }}
                                </div>
                ...
                <div class="row gutters-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class=" py-2"><span>{{ translate('Address') }} : {{Auth::user()->address }}</span>
                                    </li>
                                    {{-- <li class=" py-2"><span>{{ translate('Country') }} : {{ $address->country }}</span>
                                    </li> --}}
                                    <li class=" py-2"><span>{{ translate('Area') }} : {{ Auth::user()->areas->name }}</span></li>
                                    <li class=" py-2"><span>{{ translate('City') }} : {{Auth::user()->areas->city->name }}</span></li>
                                    {{-- <li class=" py-2"><span>{{ translate('Postal Code') }} :
                                            {{ $address->postal_code }}</span></li> --}}
                                    <li class=" py-2"><span>{{ translate('Phone') }} : {{ Auth::user()->phone }}</span></li>
                                </ul>
                                {{-- @endif
                                @endif --}}
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-5 text-center">
                            <div class="mb-1">
                                @if(Auth::user()->customer->verification_status == 0)
                        ...
                        <div class="bg-white mt-4 p-4 text-center">
                            <div class="h5 fw-600">{{ translate('Reference')}}</div>
                            <p>{{ translate('Your reference link is here')}}</p>
                            <p>{{ url('register'.'?referral_code='.Auth::user()->referral_code) }}</p>
                        </div>
