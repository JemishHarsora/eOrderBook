                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control text-capitalize" name="name" placeholder="{{ translate('Product Name') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="mb-3">
                                            <textarea class="aiz-text-editor text-capitalize" name="description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
