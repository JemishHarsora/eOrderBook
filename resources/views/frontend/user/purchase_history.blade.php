            ...
            <div class="aiz-user-panel">
                <div class="card">
                    <div class="card-header row gutters-5">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <select class="form-control aiz-selectpicker" name="seller" id="seller" data-live-search="true">
                                    <option value="">{{ ('Select sellers') }}</option>
                        ...
                        <input type="hidden" id="buyer" value="{{Auth::user()->id}}">
                        <div class="col-auto">
                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $('.export').click(function() {
            ...
            if (date != ''|| buyer != ''|| seller != '') {
                var basepth="{{ getBaseURL() }}"+"all_orders/export?date="+date+"&seller="+seller+"&buyer="+buyer;
