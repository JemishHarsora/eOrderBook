...
<section class="py-5">
            ...
            <div class="aiz-user-panel">
                <div class="aiz-titlebar mt-2 mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="h3">{{ translate('My Dashboard') }}</h1>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-4">
        <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
          <div class="px-3 pt-3">
            <div class="h3 fw-700">
              {{ count(\App\Product::where('user_id', Auth::user()->created_by)->get()) }}
            </div>
            <div class="opacity-50">{{ translate('Active Products')}}</div>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card bg-white mt-4 p-4 text-center" style="overflow: auto;word-break: break-all;">
                    <h5 class="h5 fw-600">{{ translate('Reference') }}</h5>
                <div class="card-body">
