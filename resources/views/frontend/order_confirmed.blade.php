                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ json_decode($order->shipping_address)->address }},{{ json_decode($order->shipping_address)->area }}, {{ json_decode($order->shipping_address)->city }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-6">
                                                    ...
                                                    <td>
                                                        @if ($orderDetail->product != null)
                                                            <a href="{{ route('product', $orderDetail->product->slug) }}" target="_blank" class="text-reset">
                                                                {{ $orderDetail->product->product->getTranslation('name') }}
                                                            </a>
                                                        @else
