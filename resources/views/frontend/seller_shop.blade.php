...
@section('content')
    ...
    @php
        ...
        foreach ($shop->user->priceproduct as $key => $seller_product) {
            if(isset($seller_product->product->reviews) && count($seller_product->product->reviews) > 0){
                ...
                <div class="col-lg-6 order-2 order-lg-0">
                    <ul class="list-inline mb-0 text-center text-lg-left">
                        ...
                        @if(!empty($isCustomerBlockShop))
                            <li class="list-inline-item" onclick="unblockModal()">
                                <b class="text-danger">{{ translate('unblock This Shop')}}</b>
                            </li>
                            @else
                            <li class="list-inline-item " onclick="blockAlert()">
                                <b class="text-danger">{{ translate('Block This Shop')}}</b>
                            </li>
                            @endif
                        @endif
                    </ul>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="p-1">
                            <div class="form-group text-center">
                                @if (Auth::check())
                                <button type="submit" class="btn btn-outline-danger btn-lg" onclick="postBlockUserReq({{$shop->user_id}})" style="width:175px;border-radius:25px;">{{translate('Yes')}}</button>
                                @endif
                            </div>
