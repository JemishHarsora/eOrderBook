...
<div class="col-sm-12">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Customer Verification Form')}}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('seller_verification_form.update') }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-8 form-horizontal" id="form">
                        @foreach (json_decode(\App\BusinessSetting::where('type', 'verification_form')->first()->value)
                        as $key => $element)
                        ...
                        <div class="form-group row" style="background:rgba(0,0,0,0.1);padding:10px 0;">
                            ...
                            <div class="col-lg-7">
                                <input class="form-control" type="text" name="label[]" value="{{ $element->label }}"
                                    placeholder="{{ translate('Label') }}">
                            </div>
                            <div class="col-lg-2"><span class="btn btn-icon btn-circle icon-lg"
                                    onclick="delete_choice_clearfix(this)"><i class="las la-times"></i></span></div>
                        </div>
                        @elseif ($element->type == 'select' || $element->type == 'multi_select' || $element->type ==
                        'radio')
                        <div class="form-group row" style="background:rgba(0,0,0,0.1);padding:10px 0;">
                            <input type="hidden" name="type[]" value="{{ $element->type }}">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="customer_choice_options_types_wrap_child">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-sm-offset-4">
                                            <input class="form-control" type="text" name="options_{{ $key }}[]"
                                                value="{{ $value }}" required="">
                                        </div>
                                        <div class="col-sm-2"> <span class="btn btn-icon btn-circle icon-lg"
                                ...
                                <button class="btn btn-success pull-right" type="button"
                                    onclick="add_customer_choice_options(this)"><i class="glyphicon glyphicon-plus"></i>
                                    Add option</button>
                            </div>
                            <div class="col-lg-2"><span class="btn btn-icon btn-circle icon-lg"
                                    onclick="delete_choice_clearfix(this)"><i class="las la-times"></i></span></div>
