            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td><img src="{{ uploaded_asset($product->thumbnail_img) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"  alt="{{translate('Product Image')}}" class="h-50px"></td>
