    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                <img class="mw-100" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" class="brand-icon"
                    alt="{{ get_setting('site_name') }}">
                @else
                <img class="mw-100" src="{{ static_asset('assets/img/logo.png') }}" class="brand-icon" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"
                    alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('products.admin')}}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Admin/In House Products') }}</span>
                            </a>
                        </li>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('inhouse_orders.index') }}"
                                ...
                                <span class="aiz-side-nav-text">{{translate('Admin/Inhouse orders')}}</span>
                            </a>
                        </li>
                        @endif
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('25',
                        json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            @php
                            $customer = \App\Customer::where('verification_status', 0)->where('verification_info',
                            '!=',
                            null)->count();
                            @endphp
                            <a href="{{ route('customers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Customer list') }}</span>
                                @if($customer > 0)<span class="badge badge-info">{{ $customer }}</span> @endif
                            </a>
                        </li>
                ...
                json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type',
                'vendor_system_activation')->first()->value == 1)
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Block/UnBlock') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            @php
                            $blockCount = \App\BlockUser::where('status', "0")->count();
                            @endphp
                            <a href="{{ route('unblock.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['unblock.index'])}}">
                                <span class="aiz-side-nav-text">{{ translate('All Block User') }}</span>
                                @if($blockCount > 0)<span class="badge badge-info">{{ $blockCount }}</span> @endif
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            @php
                            $blockReqCount = \App\BlockUser::where('status', "1")->count();
                            @endphp
                            <a href="{{ route('unblock.blockUserList') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['unblock.blockUserList'])}}">
                                <span class="aiz-side-nav-text">{{ translate('All Unblock Request') }}</span>
                                @if($blockReqCount > 0)<span class="badge badge-info">{{ $blockReqCount }}</span> @endif
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('in_house_sale_report.index') }}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Admin/In House Product Sale') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
