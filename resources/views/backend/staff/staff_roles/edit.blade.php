            ...
            <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Country') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('State') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('City') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Area') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
