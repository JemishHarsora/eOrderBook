        ...
        <form class="form form-horizontal mar-top" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Marketed By') }}<span class="text-danger">*</span></label>
                        <div class="col-md-8">
				...
				@if ($pos_addon != null && $pos_addon->activated == 1) --}}
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="barcode" placeholder="{{ translate('Barcode') }}" required minlength="13" maxlength="13">
                        </div>
                    </div>
                    {{-- @endif --}}
