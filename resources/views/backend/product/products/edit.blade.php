		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="form-group row">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="sku" placeholder="{{ translate('SKU Name') }}" required value="{{ $product->sku }}">
					</div>
                </div>
                <div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Manufacturer')}}</label>
					<div class="col-md-8">
						<input type="text" class="form-control" name="mfd_by" placeholder="{{ translate('Manufacturer') }}" required value="{{ $product->mfd_by }}">
					</div>
                </div>
                <div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Marketed By')}}</label>
					<div class="col-md-8">
						<input type="text" class="form-control" name="marketed_by" placeholder="{{ translate('Marketed By') }}" required value="{{ $product->marketed_by }}">
					</div>
                </div>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" placeholder="{{translate('MRP')}}" name="unit_price" class="form-control" value="{{$product->unit_price}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Selling price')}}</label>
                    <div class="col-lg-6">
                        <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Selling price')}}" name="purchase_price" class="form-control" value="{{$product->purchase_price}}" required>
                    </div>
                </div>
                <div class="form-group row">
				...
				<div class="form-group row" id="quantity">
					...
					<div class="col-lg-6">
						<input type="number" lang="en" value="{{ $product->current_stock }}" step="1" placeholder="{{translate('Stock')}}" name="current_stock" class="form-control" required>
					</div>
				</div>
				<br>
