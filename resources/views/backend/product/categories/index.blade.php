                        ...
                        <tr>
                            ...
                            <td>
                                @if ($category->banner != null)
                                    <img src="{{ uploaded_asset($category->banner) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" alt="{{ translate('Banner') }}"
                                        class="h-50px">
                                @else
                                    —
                                @endif
                            ...
                            <td>
                                @if ($category->icon != null)
                                    <span class="avatar avatar-square avatar-xs">
                                        <img src="{{ uploaded_asset($category->icon) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" alt="{{ translate('icon') }}">
                                    </span>
                                @else
                                    —
                                @endif
